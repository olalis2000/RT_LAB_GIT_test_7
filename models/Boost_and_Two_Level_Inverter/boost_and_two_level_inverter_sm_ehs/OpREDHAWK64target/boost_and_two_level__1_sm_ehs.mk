...
MODULES         = rt_matrx.c rt_printf.c rt_logging.c boost_and_two_level__1_sm_ehs_data.c boost_and_two_level__1_sm_ehs_offsets.c rtGetInf.c rtGetNaN.c rt_nonfinite.c OP_SEND.c RECV_Param.c optrigger.c
...
SHARED_SRC      = $(RELATIVE_PATH_TO_ANCHOR)\slprj\rtlab_rtmodel\_sharedutils\*.c*
SHARED_SRC_DIR  = $(RELATIVE_PATH_TO_ANCHOR)\slprj\rtlab_rtmodel\_sharedutils
...
SFS_TMP143 = $(SFS_TMP141:signalcompression.c=)
...
ifeq ($(OP_MATLABR2022B),1)
MATLABVERSION_CFLAGS = -DOP_MATLABR2022B
endif
ifeq ($(OP_MATLABR2023A),1)
MATLABVERSION_CFLAGS = -DOP_MATLABR2023A
endif
ifeq ($(OP_MATLABR2023B),1)
MATLABVERSION_CFLAGS = -DOP_MATLABR2023B
endif
ifeq ($(OP_MATLABR2024A),1)
MATLABVERSION_CFLAGS = -DOP_MATLABR2024A
endif
...
# Set Enviornment variable SHOW_COMPILER_COMMANDS to 1 to echo commands to log, used in .rules files
ifndef SHOW_COMPILER_COMMANDS  
	SHOW_COMPILER_COMMANDS = 0
endif
ifeq ($(SHOW_COMPILER_COMMANDS),1)
	Q = 
else
	Q = @
endif
